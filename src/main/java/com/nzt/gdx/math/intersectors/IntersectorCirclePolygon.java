...
public class IntersectorCirclePolygon {
    ...
    private static Vector2 tmp3 = new Vector2(); //TODO group tous les tmp
    ...
    public static boolean circlePolygon(Circle circle, Polygon polygon) {
        ...
        while (i < vertices.length / 2) {
            ...
            boolean b = Intersector.intersectSegmentCircle(tmp, tmp2, tmp3, powRadius);
            if (b)
                return true;
            i += 2;
        }
        ...
        return Intersector.intersectSegmentCircle(tmp, tmp2, tmp3, powRadius);
    }
}
