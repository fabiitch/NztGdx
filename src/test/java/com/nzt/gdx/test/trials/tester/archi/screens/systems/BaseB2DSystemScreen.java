...
public abstract class BaseB2DSystemScreen extends BaseSystemScreen {
    ...
    public void createWallScreen() {
        FixtureDefWrapper fixture = new FixtureDefWrapper(BodyDef.BodyType.StaticBody).setSensor(false)
        ...
        bodyFactory.createRectangleBody(topHorizontal, fixture);
        bodyFactory.createRectangleBody(leftVertical, fixture);
        bodyFactory.createRectangleBody(rightVertical, fixture);
    }
